...
- [newstest2021](https://github.com/NataliaKhaidanova/MT_evaluation_metrics/tree/main/Data/newstest2021) contains segment-level scores for each implemented neural metric (BLEURT-20, COMET-MQM_2021, and COMET-QE-MQM_2021) and all utilized traditional metrics (traditional metrics), as well as system-level scores for each of these metrics. Domain: news. 
